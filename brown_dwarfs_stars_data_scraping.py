...
temp_list= []
stars_csv = pd.read_csv('https://en.wikipedia.org/wiki/List_of_brown_dwarfs')
stars_csv.head()
new_stars_csv = pd.read_csv('https://en.wikipedia.org/wiki/List_of_brown_dwarfs')


new_stars_csv.drop(columns=['Distance','mass','radius'],inplace=True)
new_stars_csv.head()

new_stars_csv.to_csv('final_scraped_data.csv')

archieve_stars_df=pd.read_csv('https://en.wikipedia.org/wiki/List_of_brown_dwarfs')
